...
-(NSDate*)utcTime:(NSDateComponents*)dateComponents withOffset:(NSTimeInterval)interval
{
    ...
    // PWW Seems to be an off-by-one bug somewhere
    NSDateComponents *newComponents = [dateComponents copy];
    newComponents.day += 1;
    return [[_calendar dateFromComponents:newComponents] dateByAddingTimeInterval:(NSTimeInterval)(interval)];
